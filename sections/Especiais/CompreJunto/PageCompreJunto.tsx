...
import Card from 'deco-sites/shp/components/ComponentsSHP/Especiais/CompreJuntoCard.tsx'
...
export const PagCompreJunto=({ bannerUrl, collectionId, Jogos, descontoPix, produtos, dataFinal, filtrosCombo}:Props)=>{
  ...
  const ulComboDesk=useRef<HTMLUListElement>(null)

  const ulComboMob=useRef<HTMLUListElement>(null)
