...
const fireOffers = ({ products, finalDaOferta = '' }: Props) => {
  ...
  useEffect(() => {
    ...
    const timeOut= setInterval(()=>{
      const timeObj:boolean | Record<string,number> =finalDate && calculateTimeRemaining(new Date(), finalDate)
  ...
  return (
    <>
      <div className='flex mx-auto w-[80vw] gap-2 justify-around items-center'>
        <img src='https://shopinfo.vteximg.com.br/arquivos/icone-ofertas-fogo.png' />
        <span className="font-bold text-2xl">Suba de Nível no Arraiá Black da Shopinfo</span>
        <div class='hidden re1:flex items-center justify-center z-[2]'>
