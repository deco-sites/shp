          ...
          <div className="flex flex-col justify-center items-center">
            <label className="flex gap-1 items-center">
              <img
                ...
                alt="batata"
              />
              <p className="text-lg font-bold">{peca.name}</p>
            </label>
            <div className=" after:ml-auto after:mr-1.5 after:mt-[-20px] after:bg-[url(https://shopinfo.vteximg.com.br/arquivos/slick-arrow.png)] after:bg-no-repeat 
            after:bg-right after:flex after:w-[15px] after:h-[15px] after:rotate-90"
            >
              <select
                name={`select ${peca.name}`}
                id={index.toString()}
                className="rounded-lg p-2 py-1 border-neutral-400 border-[2px] appearance-none outline-none pr-6"
              >
