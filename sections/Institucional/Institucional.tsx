    ...
    <>
      ...
      <div className='px-4 re1:px-[5%] re4:px-[15%]'>
        ...
        <div className='flex w-full mt-16 re1:mt-40 re1:justify-between'>
          <div className='hidden re1:flex flex-col border border-neutral items-center justify-around w-[20%] h-72 text-sm text-center p-[20px]'>
            <a href='https://api.whatsapp.com/send?phone=5519982013576' className='border border-primary rounded-lg p-[10px] font-black w-[140px] text-primary hover:text-secondary hover:bg-primary'>(19) 98201-3576</a>
            <p className='text-base text-secondary'>(19) 3308-7222</p>
            <p className='text-secondary'>De segunda à sexta das 08:30h às 18h e sábados de 08:30h às 13h</p>
            <a href='/institucional/contato' className='border border-primary rounded-lg p-[10px] font-black w-[140px] text-primary hover:text-secondary hover:bg-primary'>FALE CONOSCO</a>
          </div>

          <div ref={accordionWrapper} className='join join-vertical w-full re1:w-[70%] rounded-none'>
            {Divs.map((element)=>{
              return (
                <div id={'pai-'+element.id} className='collapse collapse-arrow join-item border-y border-y-neutral first:border-t-0 last:border-b-0'>
