...
const IconeNavegacional=({href, categoryName, imgUrl}:Props)=>(
  <li className='rounded-[8px] border border-transparent bg-[url(https://shopinfo.vteximg.com.br/arquivos/backgroundImg-icons.png)]
    min-w-[100px] max-w-[100px] min-h-[100px] max-h-[100px] re1:min-w-[115px] re1:max-w-[115px] re1:min-h-[115px] re1:max-h-[115px] 
    bg-cover bg-center bg-no-repeat hover:bg-[#dd1f26] transition ease-in-out duration-300 hover:re1:shadow-[0_0_20px_0] hover:re1:shadow-[#dd1f26]
